...
{{ include "node-hostname-chart.selectorLabels" . }}
{{- if .Chart.AppVersion }}
...
*/}}
{{- define "node-hostname-chart.serviceAccountName" -}}
{{- if .Values.serviceAccount.create }}
{{- default (include "node-hostname-chart.fullname" .) .Values.serviceAccount.name }}
{{- else }}
